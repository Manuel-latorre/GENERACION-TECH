...
const info={
    ...
    image: img,
    description: 'Como analistas en comercio electrónico nuestras soluciones se centran en evaluar detenidamente datos de ventas y tráfico en línea, evaluar el rendimiento general de tiendas virtuales, detectar tendencias y oportunidades de mejora, optimizar la experiencia del usuario, llevar a cabo análisis competitivos, perfeccionar las tasas de conversión y retención de clientes, así como proponer mejoras para el sitio web y medir el retorno de la inversión en estrategias de marketing digital. Estas funciones son fundamentales para el éxito y el crecimiento sostenible de un negocio en línea, nosotros lo ofrecemos auditando y emitiendo informes profesionales.',
    // imgServices:,
    services:'Contratar un servicio de comercio electrónico especializado puede ser una decisión estratégica para aquellas empresas que deseen expandir su presencia en línea o mejorar su estrategia de ventas en línea. Aquí tienes algunos puntos positivos del por qué es necesario contratar un servicio de comercio electrónico:',
