...
const info={
    ...
    p3: 'La planificación es vital para el desarrollo de proyectos específicos, medibles, alcanzables, relevantes y temporales. Siendo esta área la que traza objetivos, gestiona recursos, controla tiempos y costos, mitiga riesgos y mejora la calidad de nuestros productos y servicios. Nuestro equipo facilita la comunicación, permite el seguimiento y aumenta la satisfacción de nuestros clientes.',
    title4:'DESARROLLO',
